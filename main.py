...
s_dataset = Subset(dataset, indices=range(0, len(dataset)//20-30))
s_dataset_test = Subset(dataset, indices=range(len(dataset)//20-30, len(dataset)//20))
...
optimizer_ft = optim.SGD(params_to_update, lr=0.0005, momentum=0.9, weight_decay=0.0005)
